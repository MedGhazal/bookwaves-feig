...
/**
 * POJO representing a DELAN1 format tag.
 * Uses URN Code40-encoded ISIL (DELAN1 = 0x19D50890) with ASCII-encoded media ID.
 ...
 */
public class DELAN1Tag extends Tag {

    private static final Logger log = LoggerFactory.getLogger(DELAN1Tag.class);
     ...
     */
    public DELAN1Tag(byte[] pc, byte[] epc, String accessKey, String killKey) {
        super(pc, epc);
     ...
     */
    public DELAN1Tag(String mediaId, byte version, boolean secured, String accessKey, String killKey) {
     ...
     */
    public DELAN1Tag(String mediaId, String accessKey, String killKey) {
    ...
    public void setMediaId(String mediaIdString) {
        ...
        epc = newEpc;
        log.debug("Updated DELAN1 mediaId to '{}' (secured={})", mediaIdString, secured);
    }
    ...
    public void setVersion(byte version) {
        epc[14] = version;
        log.debug("Set DELAN1 version byte to 0x{}", String.format("%02X", version));
    }
    ...
    private static byte[] createEPC(String mediaId, byte version, boolean secured) {
        ...
        System.arraycopy(DELAN1_HEADER, 0, epc, 0, HEADER_LENGTH);
    ...
    public String toString() {
        return String.format("DELAN1<v%d|%s|%s>", getVersion(), getMediaId(), isSecured());
    }
